...
public class StanfordNERTool implements NERTool{
	...
	{
		this("/home/samet/.bin/SocialNetworkExtractor_V2/lib/nertools/stanford/classifiers/ner-eng-ie.crf-4-conll-distsim.ser.gz");
	}
	...
	public String runTool(String inputText)
	{
		...
		try {
			...
			String text = inputText.replaceAll("ł", "l");
			text = text.replaceAll("Ł", "L");
			text = text.replaceAll("–", "-");
			text = text.replaceAll("—", "-"); //yes, "—" is actually different from "–" 
