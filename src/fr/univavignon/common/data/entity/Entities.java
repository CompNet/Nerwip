...
{	
	...
	// FILE ACCESS		/////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////
	/** Linker applied to the entities */
	private static final String ATT_LINKER = "linker";
	/** Resolver applied to the entities */
	...
	protected static final String ELT_ENTITY = "entity";
	...
	{	// schema file
		...
		String linkerStr = element.getAttributeValue(ATT_LINKER);
		if(linkerStr!=null)
		...
		List<Element> elements = element.getChildren(ELT_ENTITY);
...
//		Collections.sort(result.entities);
	...
	{	// schema file
		...
		// build xml document
		Element element = new Element(ELT_ENTITIES);
		...
		if(linker!=null)
		{	Attribute linkerAttr = new Attribute(ATT_LINKER, linker.toString());
