...
//	}
	...
	/** Id of the entity represented by this mention */
	protected static final String ATT_ENTITY_ID = "id";
	/** Mention start position */
	protected static final String ATT_START = "start";
	/** Mention end position */
	protected static final String ATT_END = "end";
...
//	}
	...
	{	AbstractMention<?> result = null;
		...
		String typeStr = element.getAttributeValue(ATT_TYPE);
