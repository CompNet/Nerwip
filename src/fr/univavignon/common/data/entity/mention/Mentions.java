...
//	}
	...
	/////////////////////////////////////////////////////////////////
	/** Resolver applied to the mentions */
	private static final String ATT_RESOLVER = "resolver";
	/** Recognizer used to detect the mentions */
	private static final String ATT_RECOGNIZER = "recognizer";
	/** Represents a creation date */
	private static final String ATT_CREATION = "creation";
	/** Represents a modification date */
	private static final String ATT_MODIFICATION = "modification";
	/** Person who originally annotated an article */
	private static final String ATT_EDITOR = "editor";
	/** A mention in a list of mentions */
	protected static final String ELT_MENTION = "mention";
	/** A list of mentions */
	private static final String ELT_MENTIONS = "mentions";
