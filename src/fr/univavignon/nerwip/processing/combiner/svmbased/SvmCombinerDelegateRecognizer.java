...
import fr.univavignon.common.data.entity.mention.PositionRelation;
...
//		}
    ...
    */
	 ...
	 */
	protected List<Map<InterfaceRecognizer,WordMention>> identifyWordMentionOverlaps(Article article, Map<InterfaceRecognizer,Mentions> mentions)
	{	List<Map<InterfaceRecognizer,WordMention>> result = new ArrayList<Map<InterfaceRecognizer, WordMention>>();
...
//			else
     ...
     * 		Problem while combining mentions.
	 */
	private void combineMentionsByWord(Article article, Map<InterfaceRecognizer,Mentions> mentions, StringBuffer rawOutput, Mentions result) throws ProcessorException
	{	// identify word-mention couples for each recognizer
		List<Map<InterfaceRecognizer,WordMention>> wordMentions = identifyWordMentionOverlaps(article,mentions);
		String rawText = article.getRawText();
		...
		Iterator<Map<InterfaceRecognizer,WordMention>> it = wordMentions.iterator();
		logger.increaseOffset();
		while(it.hasNext())
		{	// get the next word-mention map
			Map<InterfaceRecognizer,WordMention> weMap = it.next();
