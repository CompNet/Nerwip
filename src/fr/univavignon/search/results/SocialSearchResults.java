...
{	
	...
	{	super(referenceEvents);
		...
		String filePath = SearchFileNames.FO_SOCIAL_SEARCH_RESULTS + File.separator + SearchFileNames.FI_ANNOTATED_CLUSTERS;
	...
	{	logger.log("Recording all the social search results in a file"+fileName);
		...
		// create folder
		File folder = new File(SearchFileNames.FO_SOCIAL_SEARCH_RESULTS);
		folder.mkdirs();
	...
	{	String fileName = filePrefix;
		...
		String filePath = SearchFileNames.FO_SOCIAL_SEARCH_RESULTS + File.separator + fileName;
	...
	{	String folder = SearchFileNames.FO_SOCIAL_SEARCH_RESULTS;
	...
	{	String path = SearchFileNames.FO_SOCIAL_SEARCH_RESULTS + File.separator + fileName;
