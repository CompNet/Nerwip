...
//			LingPipe lingPipe = new LingPipe(chunkingMethod,true, splitSentences,trim,exclusionOn,ignorePronouns);
...
//		}
	...
	{	logger.setName("Test-Stanford");
		...
		boolean exclusionOn = false;
		boolean ignorePronouns = false;
		OpenCalais openCalais = new OpenCalais(exclusionOn,ignorePronouns);
...
//			Stanford stanford = new Stanford(model,true, exclusionOn,ignorePronouns);
...
//			boolean exclusionOn = false;
//			boolean ignorePronouns = false;
//			IllinoisModelName combiner = IllinoisModelName.CONLL_MODEL;
//			Illinois illinois= new Illinois(combiner,true, exclusionOn,ignorePronouns);
...
//			boolean exclusionOn = false;
//			boolean ignorePronouns = false;
//			OpenNlp openNlp = new OpenNlp(OpenNlpModelName.ORIGINAL_MODEL, true, false, false);
