...
public class EventComparison {
	...
	{  //text is the answer of spotlight
		...
		{   //compare person type entities
			...
			{personSim = NLDistance.getLevNorm(e1.getPerson().getStringValue(), e2.getPerson().getStringValue());} 
		}
		...
		{   //compare location type entities
			...
			{locationSim = NLDistance.getLevNorm(e1.getLocation().getStringValue(), e2.getLocation().getStringValue());} 
		...
		{   //compare organization type entities
			...
			{ if (uri1 == uri2)
			{organizationSim = 1;}
			else organizationSim = 0;
			}
			else 
			{organizationSim = NLDistance.getLevNorm(e1.getOrganization().getStringValue(), e2.getOrganization().getStringValue());} 
		...
		{   //compare function type entities
			...
			{functionSim = NLDistance.getLevNorm(e1.getFunction().getStringValue(), e2.getFunction().getStringValue());} 
		}
		else {functionSim = 0;
		...
		{   //compare production type entities
			...
			{ if (uri1 == uri2)
			{productionSim = 1;}
			else productionSim = 0;
			}
			else 
			{productionSim = NLDistance.getLevNorm(e1.getProduction().getStringValue(), e2.getProduction().getStringValue());} 
		...
		{   //compare meeting type entities
			...
			{meetingSim = NLDistance.getLevNorm(e1.getMeeting().getStringValue(), e2.getMeeting().getStringValue());} 
