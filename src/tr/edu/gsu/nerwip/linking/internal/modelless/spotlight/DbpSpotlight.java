...
import tr.edu.gsu.nerwip.recognition.internal.modelless.wikipediadater.WikipediaDaterConverter;
 ...
 */
public class DbpSpotlight extends AbstractModellessInternalRecognizer<List<MentionDate>, WikipediaDaterConverter>
{
	/**
