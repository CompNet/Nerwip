package tr.edu.gsu.nerwip.recognition.external.modelless;
 ...
 */
public abstract class AbstractModellessExternalRecognizer<U,T extends AbstractExternalConverter<U>> extends AbstractExternalRecognizer<U,T>
{	
	/**
	 ...
	 */
	public AbstractModellessExternalRecognizer(boolean trim, boolean ignorePronouns, boolean exclusionOn)
